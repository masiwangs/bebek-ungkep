...
<head>
    ...
    <title>{{ $title ?? 'Toko Resmi' }} - Droppoint Bebek Ungkep Yuk Sri</title>
...
<body>
    <div id="app">
        <div id="main" class="layout-horizontal">
            <header class="mb-5">
                <div class="header-top" style="background-color: #1f3b9d">
                    <div class="container">
                        <div class="logo">
                ...
                <nav class="main-navbar">
                    <div class="container">
                        <ul>
                            <li class="menu-item  ">
                                <a href="{{ route('droppoint.home') }}" class='menu-link'>
                                    ...
                                    <div class="submenu-group-wrapper">
                                        <ul class="submenu-group">
                                            <li class="submenu-item  ">
                                                <a href="{{ route('admin.user.list') }}" class='submenu-link'>Semua Pesanan</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
